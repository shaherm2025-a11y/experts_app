...
Future<void> _syncWithServer() async {
  try {
    final serverData = await ApiService.getQuestions();
  ...
  try {
    ...
    for (var q in [...unanswered, ...answered]) {
      ...
      await local_db.updateQuestionImagePath(q['id'], imagePath);
      ...
      try {
        ...
        await local_db.updateQuestionAudioPath(q['id'], audioPath);
      } catch (_) {}
    ...
    final localUnanswered = await local_db.getUnanswered();
    final localAnswered = await local_db.getAnswered();
                  ...
                  IconButton(
                    ...
                    onPressed: () async {
                      if (!isRecording) {
                        ...
                        if (path != null) {
                          q['answer_audio_path'] = path; // حفظ المسار
